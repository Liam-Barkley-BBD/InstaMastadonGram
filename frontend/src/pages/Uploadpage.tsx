...
const UploadMediaPage = () => {
  ...
  const handleShare = () => {
    console.log('Sharing post...', { files: selectedFiles, caption, location, taggedUsers });
              ...
              {selectedFiles.length === 0 ? (
                <div className="upload-dropzone" onClick={() => fileInputRef.current?.click()}>
                  <div className="dropzone-content">
                    <div className="dropzone-icon"><Camera size={32} /></div>
                    <p className="dropzone-title">No image content</p>
                    <p className="dropzone-subtitle">Drag photos and videos here or click to browse</p>
                  </div>
                </div>
              ) : (
